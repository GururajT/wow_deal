        ...
        <div class="main-header">
            <div class="container">
                <div class="row" style="align-items: center; display: flex;">
                    ...
                    <!-- /.logo-holder -->
                    <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12 top-search-holder" style="padding-right: 0px;">
                        <!-- /.contact-row -->
                        <!-- ============================================================= SEARCH AREA ============================================================= -->
                    ...
                    <!-- /.top-search-holder -->
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 navmenu" style="justify-content: center">
                                ...
                                <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
                                    <div class="nav-outer">
                                        <ul class="nav navbar-nav">
                                            ...
                                            <li> <a href="login.php"> <img style="display: block; margin: auto; margin-bottom: 3px;" src="images/user.png" /> My Account </a> </li>
                                            <li> <a href="cart.php"> <img style="display: block; margin: auto; margin-bottom: 3px;" src="images/shopping-cart.png" /> Cart </a> </li>
                                        </ul>
    ...
    <div class="menusec" id="myHeader">
        <div class="container">
            <div class="submenu_sec">
                <i class="togglebar"> <img src="assets/css/images/menu.png" /> </i>
                <nav class="menu">
                    <ol>
                        <li class="menu-item active">
                            <a href="#0" id="restaurent_btn"> <img src="assets/css/images/deals.png" /> Restaurents </a>
                            <!--<ol class="sub-menu">-->
                        ...
                        <li class="menu-item">
                            <a href="#0" id="auto_btn"> <img src="assets/css/images/weekend.png" /> Auto </a>
                            <!--<ol class="sub-menu">-->
                            <!--    <li class="menu-item"><a href="categories.php">Big Widgets</a></li>-->
                            <!--    <li class="menu-item"><a href="categories.php">Bigger Widgets</a></li>-->
                            <!--    <li class="menu-item"><a href="categories.php">Huge Widgets</a></li>-->
                        ...
                        <li class="menu-item">
                            <a href="#0" id="entertain_btn"> <img src="assets/css/images/coupon.png" /> Entertainment</a>
                            <!--<ol class="sub-menu">-->
                            <!--    <li class="menu-item"><a href="categories.php">Big Widgets</a></li>-->
                            <!--    <li class="menu-item"><a href="categories.php">Bigger Widgets</a></li>-->
                            <!--    <li class="menu-item"><a href="categories.php">Huge Widgets</a></li>-->
                        ...
                        <li class="menu-item">
                            <a href="#0" id="health_btn"> <img src="assets/css/images/restaurant.png" /> Health</a>
                            <!--<ol class="sub-menu">-->
                            <!--    <li class="menu-item"><a href="categories.php">Big Widgets</a></li>-->
                            <!--    <li class="menu-item"><a href="categories.php">Bigger Widgets</a></li>-->
                            <!--    <li class="menu-item"><a href="categories.php">Huge Widgets</a></li>-->
